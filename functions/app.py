...
def main():
    ...
    last_played = spotify_client.get_last_played_tracks(num_last_played)
    ...
    idxs = input("\nEnter a list of up to 5 tracks you'd like to use as seeds. Use indexes separated by a space: (e.g. 1 2) ")
    idxs = idxs.split()
    seed_tracks = [last_played[int(index)-1] for index in idxs]
